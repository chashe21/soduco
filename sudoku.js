...
function cleanSudokuTable() {
    for (let i = 0; i < 9; i++) {
        for (let j = 0; j < 9; j++) {
            // document.getElementById('sudokuTable').rows[i].cells[j].value = ;
            let newSudokuInput = document.createElement("input");
            newSudokuInput.setAttribute("type", "text", "class", "sudokuInputs", "maxlength", "1");
